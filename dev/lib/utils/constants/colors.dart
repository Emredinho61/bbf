...
class BColors {
  ...
  static Color navbarLight = const Color(
    0xFFCDD8EC,
  ); // same blue-grey family as bg, visibly darker
  static Color navbarDark = const Color(
    0xFF1A2540,
  ); // same navy family as bg, visibly lighter
